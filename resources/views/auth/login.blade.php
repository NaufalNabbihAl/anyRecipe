                    ...
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div class="flex justify-between mt-3">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('auth.create') }}" class="font-poppins font-medium text-sm text-[#3D3D3D]">Buat Akun</p>
                            </div>
                            <a href="{{ route('auth.reset') }}" class="font-poppins font-medium text-sm text-[#3D3D3D]">Lupa Password
                                ?</a>
                        </div>
                    </form>
            ...
            <div class="flex min-h-full flex-col justify-center px-6 lg:px-8 sm:py-6 lg:py-1 ">
                ...
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2
                        class="mt-8 text-center text-2xl font-poppins font-semibold leading-9 tracking-tight text-[#3D3D3D]">
                        Gagal Masuk</h2>
                    <p class="text-center font-poppins font-normal ">Sepertinya kamu salah masukan nama pengguna atau
                        password
                ...
                <div class="mt-5 mb-5 sm:mx-auto sm:w-full sm:max-w-sm ">
                    <div>
                        <a href="{{ route('auth.login') }}"
                            class="flex w-full h-10 justify-center text-white bg-[#FBBC05] rounded bg-gradient-to-r px-4 py-2 font-poppins font-normal leading-6 shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Coba Lagi</a>
                    </div>
                </div>
            </div>
        </div>
