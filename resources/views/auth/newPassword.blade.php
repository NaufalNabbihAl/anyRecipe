<x-layout>
    ...
    <main class="relative z-10">
        ...
        <div class="mx-auto mt-28 md:mt-14 sm:px-6 lg:px-1 max-w-sm block px-4 ">
            <div class="flex min-h-full flex-col justify-center px-4 lg:px-8 sm:py-6 lg:py-1 ">
                @if (session('error'))
                    <div class="text-white w-44 ms-16 h-7 rounded-md bg-red-500 -mt-5 mb-10 flex justify-center">
                        <ul>
                            <li>{{ session('error') }}</li>
                        </ul>
                    </div>
                ...
                @elseif (session('success'))
                    <div class="text-white w-48 ms-16 h-7 rounded-md bg-[#54FB05] -mt-5 mb-10 flex justify-center">
                        <ul>
                ...
                <div class="mt-3">
                    <p class="text-center font-poppins font-thin  text-gray-400">Masukkan password baru yang akan kamu
                        gunakan ya</p>
                </div>
                <div>
                    <form class="space-y-6" action="{{ route('auth.newPasswordStore') }}" method="POST">
                        @csrf
                        <div>
                        ...
                        <div>
                            <div class="mt-4 relative" x-data="{ showPassword: false }">
                                <input :type="showPassword ? 'text' : 'password'" id="password" name="confirm_password"
