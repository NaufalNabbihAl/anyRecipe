<x-layout>
            ...
            <form class="mx-4 ">
                ...
                <div class="relative">
                    ...
                    <div class="flex">
                        ...
                        <div class="bg-gray-100 h-12 flex items-center rounded-md p-3 ms-2 hover:text-white hover:bg-[#FBBC05] ">
                        ...
                        <div class="bg-gray-100 h-12 flex items-center rounded-md p-3 ms-2 hover:text-white hover:bg-gradient-to-r hover:from-[#FD666D] hover:to-[#FBBC05]">
    ...
    <main class="pt-36 ">
        <div class="mx-auto md:mt-2 lg:px-8 max-w-sm " >
            <div class="w-auto px-1">
                <div class="flex justify-between">
                    <div class="relative">
                        <button>
                            <img src="http://127.0.0.1:8000/images/bookmark.svg" class="absolute top-6 right-1 w-8 h-8 "
                                alt="">
                        </button>
                        <div>
                        ...
                        <div class="flex items-center">
                            <svg id="fi_2107957" enable-background="new 0 0 24 24" height="32" viewBox="0 0 24 24"
