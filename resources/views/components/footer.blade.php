    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        navItems.forEach(item => {
            ...
            if (currentUrl.includes(itemUrl)) {
                item.querySelector('svg').classList.add('active-svg');
                item.querySelector('p').classList.add('active-text');
            }
        });
    });
</script>
...
<div class="bg-white w-full h-14 pt-3 fixed bottom-0 right-0">
    <div class="flex justify-around items-center">
        ...
        <a href="{{ route('user.search') }}" class="nav-item text-gradient flex flex-col items-center group">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="icon">
                <defs>
                    <linearGradient id="grad-default" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" style="stop-color:#3d3d3d;stop-opacity:1" />
        ...
        <a href="{{ route('user.upload') }}" class="nav-item text-gradient flex flex-col items-center group">
        ...
        <a href="{{ route('articles.index') }}" class="nav-item  text-gradient flex flex-col items-center group">
